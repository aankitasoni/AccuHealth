...
# page settings
st.set_page_config(page_title="AccuHealth", page_icon="🚑", layout="wide")

curr_path = os.path.dirname(os.path.realpath(__file__))

st.markdown("<h1 align='center' class='app_title'><style> .app_title {color: #541690; word-spacing: 10px; font-size: 70px; margin-top: -100px;}  </style> Patient Survival Prediction App</h1>", unsafe_allow_html=True)
...
st.sidebar.markdown("<h2 class='sidehead' align='center'><style> .sidehead {color:#541690; background:white; border-radius: 5px;}</style> AccuHealth</h2>", unsafe_allow_html=True)
...
if submit_val and explain_model:
    ...
    <p style="color:#CCF3EE;"> #CCF3EE dots indicate those observations that impact the prediction that the patient would survive.</p>
    <p style="color:#541690;"> #541690 dots indicate those observations that impact the prediction that the patient would not survive.</p> 
    ...
    <p style="color:#541690;">Higher values of <b>'ventialted_apache'</b> and <b>'age'</b> has a greater impact on the prediction that the patient would not survive. </p>
